...
router.get('/:id/geofence', planFeatureGate('geofence'), asyncHandler(branchController.getGeofence));
router.post('/:id/geofence/test', planFeatureGate('geofence'), asyncHandler(branchController.testGeofence));
router.put('/:id/geofence', planFeatureGate('geofence'), asyncHandler(branchController.updateGeofence));
